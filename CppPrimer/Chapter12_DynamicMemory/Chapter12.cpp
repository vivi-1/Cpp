...
//E12.4 In our check function we didn’t check whether i was greater than zero.
//Why is it okay to omit that check?

//E12.5 We did not make the constructor that takes an initializer_list explicit
